...
bool vote(int voter, int rank, string name)
{
    // See if string name matches name of valid candidate.
    // If it does, update global preferences array to indicate that voter has
    // that candidate as their rank preference (0=1st preference, 1=2nd...).
    bool exist = false;
    for (int i = 0; i < candidate_count; i++)
    {
