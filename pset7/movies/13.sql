-- Write a SQL query to list the names of all people who starred in a movie in
...
-- select the Kevin Bacon born in 1958. Kevin Bacon himself should not be included
...
(SELECT DISTINCT movies.title FROM
people JOIN stars ON people.id = stars.person_id
JOIN movies ON stars.movie_id = movies.id
